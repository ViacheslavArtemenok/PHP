...
<body>
        ...
        <div class="main_tittle_box">
            <div class="main_tittle">
                ...
                <div class="way">
                    ...
                    <a class="way_text" href="catalog_women.php">WOMEN&nbsp;</a>
                    <a class="way_text" href="catalog_women.php">NEW ARRIVALS</a>
                </div>
            </div>
        </div>
    ...
    <div class="wrap_product">
        <div class="product_item">
            <a href="cart.html">
                <div class="box_pict">
                    <img class="pict_img" src="img/product_w1.jpg" alt="product">
        ...
        <div class="product_item">
            <a href="cart.html">
                <div class="box_pict">
                    <img class="pict_img" src="img/product_w2.jpg" alt="product">
                    <div class="bord_add_to_cart">
                        <div class="add_to_cart">
                            <img class="add_to_cart_img" src="img/cart.svg" alt="cart">
                            <p class="add_to_cart_text">Add to Cart</p>
        ...
        <div class="product_item">
            <a href="cart.html">
                <div class="box_pict">
                    <img class="pict_img" src="img/product_w3.jpg" alt="product">
                    <div class="bord_add_to_cart">
                        <div class="add_to_cart">
                            <img class="add_to_cart_img" src="img/cart.svg" alt="cart">
                            <p class="add_to_cart_text">Add to Cart</p>
        ...
        <div class="product_item">
            <a href="cart.html">
                <div class="box_pict">
                    <img class="pict_img" src="img/product_w4.jpg" alt="product">
                    <div class="bord_add_to_cart">
                        <div class="add_to_cart">
                            <img class="add_to_cart_img" src="img/cart.svg" alt="cart">
                            <p class="add_to_cart_text">Add to Cart</p>
        ...
        <div class="product_item">
            <a href="cart.html">
                <div class="box_pict">
                    <img class="pict_img" src="img/product_w5.jpg" alt="product">
                    <div class="bord_add_to_cart">
                        <div class="add_to_cart">
                            <img class="add_to_cart_img" src="img/cart.svg" alt="cart">
                            <p class="add_to_cart_text">Add to Cart</p>
        ...
        <div class="product_item">
            <a href="cart.html">
                <div class="box_pict">
                    <img class="pict_img" src="img/product_w6.jpg" alt="product">
                    <div class="bord_add_to_cart">
                        <div class="add_to_cart">
                            <img class="add_to_cart_img" src="img/cart.svg" alt="cart">
                            <p class="add_to_cart_text">Add to Cart</p>
        ...
        <div class="product_item">
            <a href="cart.html">
                <div class="box_pict">
                    <img class="pict_img" src="img/product_w7.jpg" alt="product">
                    <div class="bord_add_to_cart">
                        <div class="add_to_cart">
                            <img class="add_to_cart_img" src="img/cart.svg" alt="cart">
                            <p class="add_to_cart_text">Add to Cart</p>
        ...
        <div class="product_item">
            <a href="cart.html">
                <div class="box_pict">
                    <img class="pict_img" src="img/product_w8.jpg" alt="product">
                    <div class="bord_add_to_cart">
                        <div class="add_to_cart">
                            <img class="add_to_cart_img" src="img/cart.svg" alt="cart">
                            <p class="add_to_cart_text">Add to Cart</p>
        ...
        <div class="product_item">
            <a href="cart.html">
                <div class="box_pict">
                    <img class="pict_img" src="img/product_w9.jpg" alt="product">
                    <div class="bord_add_to_cart">
                        <div class="add_to_cart">
                            <img class="add_to_cart_img" src="img/cart.svg" alt="cart">
                            <p class="add_to_cart_text">Add to Cart</p>
