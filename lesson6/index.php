...
<body>
    <header>
        <div class="header_up">
            <div class="wrap_head">
                <div class="logo_left">
                    <a class="logo_left_img" href="index.php"><img src="img/logo.svg" alt="logo"></a>
                ...
                <div class="logo_right">
                    <details id="header_menu" class="logo_right_img menu">
                        ...
                        <div class="list_box">
                            ...
                            <a class="pink_list hide_tittle" href="reviews.php">registration</a>
                            <a class="pink_list hide_tittle" href="cart.html">cart</a>
                        </div>
                    </details>
                    <a class="logo_right_img" href="reviews.php"><svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a class="logo_right_img" href="cart.html"><svg width="32" height="29" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            if ($data['id'] != 3 &&  $data['id'] != 6 && $data['id'] != 7) { ?>
                <div class="product_item">
                    ...
                    <form action="product.php" method="POST" enctype="multipart/form-data">
                        <input class="hide" name="gender" type="text" value="<?= $some_gender ?>">
                        <input class="hide" name="name" type="text" value="<?= $data['name'] ?>">
                        <input class="hide" name="price" type="text" value="<?= $data['price'] ?>">
                        <input class="hide" name="number_g" type="text" value="<?= $get_gender ?>">
                        <input class="hide" name="photo_name" type="text" value="<?= $data['photo_name'] ?>">
                        <input class="hide" name="about" type="text" value="<?= $taskList[$data['id']] ?>">
    ...
    <footer>
        ...
        <div class="footer_lower">
            <div class="wrap_foot_lower">
                <p class="rights">&#169; <?= date('Y') ?> Brand All Rights Reserved.</p>
