...
<body>
    ...
    <div class="box_collection">
        ...
        <div class="collection_menu">
            <details class="collection_select">
                <summary class="list_summary">
                    CHOOSE COLOR
                ...
                <div class="input_box">
                    <label><input class="check_box" id="color_1" type="checkbox"> <svg width="18" height="12" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M31.4506 0H0V32H31.4506V0Z" fill="#6b7e4d" />
                        </svg>
                    </label>
                    <label><input class="check_box" id="color_2" type="checkbox"> <svg width="18" height="12" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M31.4506 0H0V32H31.4506V0Z" fill="#224f8a" />
                        </svg></label>
                    <label><input class="check_box" id="color_3" type="checkbox"> <svg width="18" height="12" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M31.4506 0H0V32H31.4506V0Z" fill="#c7912c" />
                        </svg></label>
                    <label><input class="check_box" id="color_4" type="checkbox"> <svg width="18" height="12" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M31.4506 0H0V32H31.4506V0Z" fill="#a1a1a1" />
                        </svg></label>
                </div>
            </details>
            <details class="collection_select">
            ...
            <details class="collection_select">
                ...
                <div class="input_box">
                    <label><input class="check_box" id="in_amo_1" type="checkbox"> 1</label>
                    <label><input class="check_box" id="in_amo_2" type="checkbox"> 2</label>
                    <label><input class="check_box" id="in_amo_3" type="checkbox"> 3</label>
                    <label><input class="check_box" id="in_amo_4" type="checkbox"> 4+</label>
                </div>
            </details>
        </div>
        <a class="collection_add_box" href="cart.html">
