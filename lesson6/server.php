...
<body>
    ...
    <?php
    include "config.php";
    if (!empty($_POST['name']) && !empty($_POST['text_review']) && $_POST['answer'] == $_POST['correct']) {
        echo $get_name = $_POST['name'];
        echo $get_city = $_POST['city'];
    ...
    if (!$_POST['correct']) {
        ...
        while ($data = mysqli_fetch_assoc($res)) { ?>
            <div class="review_block">
                ...
                <p class="text_right"><?= $taskList[$data['id']] ?></p>
            </div>
    <?php
        }
    }
    ?>
    <?php
    if ($_POST['correct'] && $_POST['answer'] != $_POST['correct']) {
        $info_error = '<h3 class="pink_tittle">CAPTURE ERROR</h3>'; ?>
        <header>
            <div class="header_up">
                <div class="wrap_head">
                    <div class="logo_left">
                        <a class="logo_left_img logo_main logo_main" href="index.php"><img src="img/logo.svg" alt="logo"></a>
                        <details class="details_search">
                            ...
                            <form class="area_search" action="product.php">
