...
<body>
    ...
    <div class="reg_wrap">
        <form class="reg_block_left" action="server.php" method="POST" enctype="multipart/form-data">
            ...
            <input class="reg_inp" name="name" type="text" required placeholder="Name">
            <br>
            <p class="reg_tittle_name">Your city</p>
            <input class="reg_inp" name="city" type="text" required placeholder="City">
            <br>
            <p class="reg_tittle_name">Your photo</p>
            <input class="reg_inp" type="file" name="photo" accept="image/*">
        ...
        <div class="reviews_box">
            <?php
            include "render.php"; //Здесь будут вставляться отзывы///////////////////////////////////////////////////////////////////////////////////////////////
            include "config.php"; ?>
        </div>
    </div>
